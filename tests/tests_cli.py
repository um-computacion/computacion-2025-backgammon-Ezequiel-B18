...
from cli.cli import BackgammonCLI, GameQuitException
...
class TestBackgammonCLI(unittest.TestCase):
    ...
    def test_start_game_with_custom_names(self, mock_game_loop, mock_print, mock_input):
    ...
    @patch('builtins.print')
    @patch.object(BackgammonCLI, 'game_loop')
    def test_start_game_with_default_names(self, mock_game_loop, mock_print, mock_input):
    ...
    def test_game_loop_basic(self, mock_handle_move, mock_display_info, mock_display_board, mock_input):
    ...
    @patch.object(BackgammonCLI, 'display_current_player_info')
    @patch.object(BackgammonCLI, 'handle_player_move')
    def test_game_loop_with_quit(self, mock_handle_move, mock_display_info, mock_display_board, mock_input):
